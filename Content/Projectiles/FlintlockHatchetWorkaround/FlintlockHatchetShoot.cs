...
namespace Revelations.Content.Projectiles.FlintlockHatchetWorkaround
{
    public class FlintlockHatchetShoot : ModProjectile
    {
        ...
        {
            // I took a bunch of code from the examplemod shortsword, but the projectile doesn't move outside of tracking the player, and should not do any damage or hit anything
