...
{
    public class EternalEnchantment : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe = CreateRecipe();
            recipe.AddIngredient(ModContent.ItemType<EternalBoots>());
            recipe.AddIngredient(ModContent.ItemType<CryosplashNinjaGear>());
            recipe.AddTile(TileID.TinkerersWorkbench);
            recipe.Register();
        }
    }
