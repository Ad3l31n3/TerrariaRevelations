        ...
        public override void AI()
        {
            ...
            switch ((AIState)NPC.ai[0])
            {
                case AIState.Idle:
                    ...
                    // Check for player
                    if (player.active && !player.dead && Vector2.Distance(NPC.Center, player.Center) < detectRange && NPC.ai[1] >= 60) //Gives a 1 second cooldown between entering idle and targeting
                    {
